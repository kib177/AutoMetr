...
└── sitemap.xml             # Карта сайта (если создадите)
\`\`\`
...
Проект разработан для автосервиса «АвтоМэтр» (2026).
Вы можете свободно использовать его в качестве основы для собственного сайта СТО.
Автор не несёт ответственности за содержание и работоспособность сторонних API (Яндекс.Карты, Font Awesome).
